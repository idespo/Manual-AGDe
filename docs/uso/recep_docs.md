...
## Documentos que ingresan sin identificador único (consecutivo)

1. Crear el documento con código
    1. Ingrese a la carpeta **"Recepción de docunentos"**.
    2. Seleccione la opción **"Crear docunento con código"**.
    3. Complete los campos requeridos:
        1. Seleccione **UNA**
        2. Tipo de remitente: **Externo (EXT)**
        3. Código de la instancia
        4. Serie documental
        5. Haga clic en **Guardar**
2. Asignar el código al archivo
    1. El sistema generará un identificador único (consecutivo).
    2. Copie ese código y asígnele ese nombre al archivo almacenado en su computadora (renombrar archivo).
    3. Luego, utilie la opción **"Cargar nueva versión"** para subir el documento al sistea.
3. Verificar la firma digital certificada
    1. Asegurarse de que cuente con firma digital certificada válida.
4. Editar propiedades del documento
    1. Ingrese a la opción **"Editar propiedades"** y complete la información correspondiente.
5. Trasladar el documento
    1. Aplique la regla **"TRAMITAR DOCUNMENTOS"** para que la persona responsable pueda gestionar o asignar la tarea correspondiente.